  ...
  return (
    <div>
      <main className="w-full max-w-[520px] mt-16">
        <div className="bg-white border-2 border-black rounded-xl overflow-hidden neo-brutalism-shadow transition-all">
          <div className="graph-paper h-64 w-full flex items-center justify-center border-b-2 border-black bg-white">
            <div className="flex flex-col items-center">
              <div className="relative">
                <div className="w-40 h-40 bg-zinc-50 rounded-full border-2 border-dashed border-zinc-300 flex items-center justify-center relative">
                  ...
                  <div className="absolute -top-2 -right-2 bg-white px-2 py-1 border border-black rounded-md text-xs font-bold">
                    Hẹn gặp lại!
                  </div>
                </div>
              </div>
          ...
          <div className="px-8 pb-8 flex flex-col gap-4">
            <button
              ...
              className="w-full bg-black text-white h-14 rounded-lg font-bold text-lg flex items-center justify-center gap-2 border-2 border-black transition-all hover:opacity-90 active:scale-[0.98]"
            >
              Đăng xuất {isLoading && <CircularProgress />}
            </button>
            <button
              onClick={() => onClose(false)}
              className="w-full bg-white text-black h-14 rounded-lg font-bold text-lg border-2 border-black transition-all neo-brutalism-secondary active:scale-[0.98]"
            >
              Ở lại học tiếp
            </button>
          </div>
