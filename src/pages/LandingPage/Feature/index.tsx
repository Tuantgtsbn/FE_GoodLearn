...
function FeatureLandingPage() {
  ...
  return (
    <div className="bg-graph-paper text-foreground font-sans selection:bg-brandYellow .mx_LandingPageFeature">
      <section className="relative overflow-hidden pt-20 pb-10 md:py-20 px-4">
        ...
        >
          <h1 className="text-5xl md:text-7xl font-black mb-8 leading-none">
            ...
            <span className="bg-brandYellow text-black px-2 border-4 inline-block -rotate-1 transform">
              "Hack"
            </span>{' '}
            Điểm Số
          </h1>
      ...
      <main className="max-w-6xl mx-auto px-4 md:py-16 space-y-16 md:space-y-32 ">
        ...
        >
          <div className="md:w-1/2 order-2 md:order-1">
            ...
            <p className="text-lg font-bold text-black dark:text-[#d9d9d9] mb-8 leading-relaxed">
            ...
            <button className="bg-brandYellow text-black px-6 py-2 border-2 rounded-xl font-extrabold shadow-brutal-sm hover:-translate-y-0.5 hover:shadow-brutal transition-all active:translate-y-[2px] active:shadow-none">
              Thử AI ngay
            </button>
          </div>
          <div className="w-full md:w-1/2 order-1 md:order-2">
            <div className="bg-brandPurple neo-brutal-card p-6 aspect-square flex items-center justify-center relative overflow-hidden group">
              <div className="bg-background border-2 rounded-xl p-4 w-full h-full shadow-brutal-sm flex flex-col gap-4">
                <div className="bg-muted border-2 rounded-lg p-3 text-sm font-bold">
                  Việt Nam có bao nhiêu dân tộc nhỉ?
                </div>
                <div className="bg-brandPurple/20 border-2 rounded-lg p-3 text-sm font-bold self-end max-w-[80%]">
        ...
        >
          <div className="w-full md:w-1/2">
            <div className="bg-brandCyan neo-brutal-card p-12 aspect-square flex items-center justify-center relative">
              <div className="relative w-48 h-64">
                <div className="absolute inset-0 bg-background border-4 rounded-2xl rotate-6 shadow-brutal-sm flex items-center justify-center p-4">
                  <span className="font-black text-center">Mitosis là gì?</span>
                </div>
                <div className="absolute inset-0 bg-brandYellow border-4 rounded-2xl -rotate-3 translate-x-4 shadow-brutal-sm flex items-center justify-center p-4">
          ...
          <div className="md:w-1/2">
            ...
            <button className="neo-brutal-btn text-black bg-brandCyan">
              Tạo Flashcard
            </button>
          </div>
        </section>
        ...
        >
          <div className="md:w-1/2 order-2 md:order-1">
            ...
            <button className="neo-brutal-btn text-black bg-brandPink">
              Gọi Karaoke Ngay
            </button>
          </div>
          <div className="w-full md:w-1/2 order-1 md:order-2">
            <div className="bg-brandPink neo-brutal-card p-12 aspect-square flex flex-col items-center justify-center gap-6 relative">
              <div className="w-32 h-32 bg-background rounded-full border-4 flex items-center justify-center text-6xl shadow-brutal-sm">
                🎤
              </div>
        ...
        >
          <div className="md:w-1/2">
            <div className="bg-brandYellow neo-brutal-card p-8 aspect-square flex items-center justify-center relative">
              <div className="w-full space-y-4">
                <div className="bg-background border-2 p-3 font-black rounded-lg">
                  Câu 1: Chiến dịch Điện Biên Phủ diễn ra năm nào?
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-background border-2 p-2 rounded-lg text-center font-bold hover:bg-brandCyan cursor-pointer">
                    A. 1945
                  </div>
                  <div className="bg-brandCyan border-2 p-2 rounded-lg text-center font-bold relative">
                    B. 1954
          ...
          <div className="md:w-1/2">
            ...
            <button className="neo-brutal-btn text-black bg-brandYellow">
              Vào Đấu Trường
            </button>
          </div>
        </section>
